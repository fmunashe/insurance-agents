    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Client</a></li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$client->surname}}" class="form-control @error('surname') is-invalid @enderror" name="surname">
                                    @error('surname')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$client->mobile}}" class="form-control @error('mobile') is-invalid @enderror" name="mobile">
                                    @error('mobile')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" value="{{$client->email}}" class="form-control @error('email') is-invalid @enderror" name="email">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('gender') is-invalid @enderror" name="gender">
                                        @foreach(\App\Enum\Gender::GENDERS as $gender)
                                            <option value="{{$gender}}" {{$client->gender == $gender?'selected':null}} >{{$gender}}</option>
                                        @endforeach
                                    </select>
                                    @error('gender')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" name="address">{{$client->address}}</textarea>
                                    @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
