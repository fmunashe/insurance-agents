    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{route('suppliers.index')}}">Providers</a></li>
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Provider</a></li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-xl-12 col-xxl-12 col-sm-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h5 class="card-title text-white">Insurance Provider Details</h5>
                </div>
                <div class="card-body">
